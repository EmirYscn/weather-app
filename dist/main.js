...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;AACxB;AACA;EACE,aAAa;EACb,oDAAoD;EACpD,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,QAAQ;AACV;AACA;EACE,eAAe;AACjB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,aAAa;EACb,YAAY;EACZ,YAAY;AACd;AACA;EACE,aAAa;EACb,YAAY;AACd;AACA;EACE,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,4BAA4B;AAC9B;;AAEA;EACE,mBAAmB;EACnB,uCAAuC;AACzC;;AAEA;EACE,eAAe;EACf,WAAW;EACX,iBAAiB;EACjB,aAAa;EACb,YAAY;EACZ,uBAAuB;EACvB,YAAY;AACd;AACA;EACE,eAAe;AACjB;AACA;;EAEE,0BAA0B;AAC5B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,qCAAqC;EACrC,QAAQ;AACV","sourcesContent":["* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\nbody {\n  height: 100vh;\n  background: linear-gradient(90deg, #109ab3, #460574);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 3em;\n}\nnav {\n  margin-top: 2em;\n}\ninput[type=\"text\"] {\n  padding: 10px;\n  border-radius: 16px;\n  outline: none;\n  border: none;\n  width: 256px;\n}\n.search-button {\n  outline: none;\n  border: none;\n}\n.search {\n  width: max-content;\n  display: flex;\n  align-items: center;\n  padding: 14px;\n  border-radius: 28px;\n  background: #f6f6f6;\n  transition: box-shadow 0.25s;\n}\n\n.search:focus-within {\n  background: #f1f1f1;\n  box-shadow: 0 0 2px rgba(0, 0, 0, 0.75);\n}\n\n.search-input {\n  font-size: 16px;\n  color: #333;\n  margin-left: 14px;\n  outline: none;\n  border: none;\n  background: transparent;\n  width: 300px;\n}\n.search-icon {\n  cursor: pointer;\n}\n.search-input::placeholder,\n.search-icon {\n  color: rgba(0, 0, 0, 0.25);\n}\n\n.main-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  color: white;\n}\n\n.section-weather {\n  display: flex;\n}\n\n.weather-main {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.weather-main-top {\n  display: flex;\n  align-items: center;\n}\n.weather-main-bottom {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.weather-details {\n  display: grid;\n  grid-template-columns: auto auto auto;\n  gap: 2em;\n}\n"],"sourceRoot":""}]);
// Exports
